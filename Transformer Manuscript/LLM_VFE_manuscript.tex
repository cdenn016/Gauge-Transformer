...
\textbf{SO(3)} & \textbf{$\ell$=1,4,5,6,7 (5 irreps)} & \textbf{7.8M} & \textbf{183} & \textbf{---} & \textbf{275$\times$} \\
...
\begin{figure}[t]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{VFE_LLM Manuscript/training_curves_so20.png}
...
\begin{figure}[t]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{VFE_LLM Manuscript/train_val_gap_so20.png}
        \caption{Gauge VFE (SO(20))}
        \label{fig:gap_vfe}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{VFE_LLM Manuscript/train_val_gap_std_24M.png}
        \caption{Standard Transformer (param-matched)}
        \label{fig:gap_baseline}
    \end{subfigure}
    \caption{Train-validation gap over 200,000 training steps on WikiText-103. \textbf{(a)} Gauge VFE (SO(20)) shows the characteristic gap between training VFE loss and validation cross-entropy. \textbf{(b)} Standard transformer (param-matched) for comparison.}
